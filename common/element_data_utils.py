...
class ElementDataUtils(object):
    def __init__(self,page_name,element_path=excel_path):
        ...
        self.sheet = self.work_book.sheet_by_name(self.page_name)
    ...
    def get_element_info(self):
        ...
        for i in range(1, self.row_count):  # row_count=4 取1、2、3行
            ...
            elements_info['locator_type'] = self.sheet.cell_value(i, 2)
            elements_info['locator_value'] = self.sheet.cell_value(i, 3)
            elements_info['timeout'] = self.sheet.cell_value(i, 4)
